    ...
    <section className="hero-fullscreen relative">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        <video
          ...
          preload="auto"
        >
          {/* Your custom video - OG Reel.mp4 */}
          <source src="/OG Reel.mp4" type="video/mp4" />
          {/* Fallback videos */}
        ...
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 bg-black rounded-lg flex items-center justify-center shadow-lg">
            <div className="relative w-8 h-8">
              {/* Outer crescent */}
              <div className="absolute w-8 h-8 border-2 border-white rounded-full border-r-0 border-b-0 transform rotate-45"></div>
              {/* Middle crescent */}
              <div className="absolute w-6 h-6 border border-white rounded-full border-r-0 border-b-0 transform rotate-45 top-1 left-1"></div>
              {/* Inner crescent */}
              <div className="absolute w-3 h-3 border border-white rounded-full border-r-0 border-b-0 transform rotate-45 top-2.5 left-2.5"></div>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-2xl font-bold text-white">ONIX</span>
            <span className="text-sm text-gray-300 -mt-1">GROUP OF COMPANIES</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-8 right-8 z-10">
        <nav className="flex space-x-8">
          <a href="#about" className="text-white hover:text-gray-300 font-medium transition-colors duration-200 text-sm uppercase tracking-wide cursor-pointer">
            ABOUT
          </a>
      ...
      <div className="absolute bottom-20 left-8 max-w-2xl z-10">
        ...
        {/* Main headline */}
        <h1 className="text-3xl sm:text-4xl lg:text-6xl font-light mb-6 leading-tight text-white">
