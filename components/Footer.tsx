      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold">ONIX</span>
                <span className="text-sm text-gray-400 -mt-1">GROUP OF COMPANIES</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-300">Structural Engineering</span></li>
              <li><span className="text-gray-300">Civil Engineering</span></li>
              <li><span className="text-gray-300">MEP Engineering</span></li>
