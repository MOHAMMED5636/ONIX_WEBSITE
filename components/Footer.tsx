      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><span className="text-white text-sm">STRUCTURAL ENGINEERING</span></li>
              <li><span className="text-white text-sm">CIVIL ENGINEERING</span></li>
              <li><span className="text-white text-sm">MEP ENGINEERING</span></li>
              <li><span className="text-white text-sm">PROJECT MANAGEMENT</span></li>
              <li><span className="text-white text-sm">CONSULTATION</span></li>
            </ul>
          </div>
